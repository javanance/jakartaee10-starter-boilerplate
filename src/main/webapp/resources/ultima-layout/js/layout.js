...
PrimeFaces.widget.Ultima = PrimeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        this.leftPanel = this.wrapper.children('.layout-leftpanel');
        ...
        this.topbarMenuButton = $('#topbar-menu-button');
				this.leftPanelButton = $('#leftpanel-menu-button');
    ...
    _bindEvents: function() {
        ...
        this.topbarMenuButton.off('click.topbarButton').on('click.topbarButton', function(e) {
            ...
            if($this.topbarItems.hasClass('topbar-items-visible')) {
                ...
                $this.topbarItems.addClass('topbar-items-visible fadeInDown');
						...
						$this.leftPanel.removeClass('layout-leftpanel-active');
            $this.leftPanelButton.removeClass('leftpanel-btn-active');
            ...
            e.preventDefault();
				...
				this.leftPanelButton.off('click.leftpanel').on('click.leftpanel', function(e) {
         		$this.leftPanelButtonClick = true;
						$this.wrapper.toggleClass('layout-leftpanel-active')
            $this.leftPanel.toggleClass('layout-leftpanel-active');
            //$this.closeOverlayMenu();
        ...
        this.rightPanelButton.off('click.rightpanel').on('click.rightpanel', function(e) {
            $this.rightPanelButtonClick = true;
						$this.wrapper.toggleClass('layout-rightpanel-active')
            $this.rightPanel.toggleClass('layout-rightpanel-active');
            
            e.preventDefault();
        });

				 this.leftPanel.off('click.leftpanel').on('click.leftpanel', function(e) {
        ...
        $(document.body).off('click.layoutBody').on('click.layoutBody', function(e) {
           ...
           /* if(!$this.rightPanelClick && !$this.rightPanelButtonClick && $this.rightPanel.hasClass('layout-rightpanel-active') && !$this.isDatePickerPanelClicked() && !$this.isOverlayInputPanelClicked(e)) {
            ...
            $this.leftPanelButtonClick = false;
    ...
    closeOverlayMenu: function() {
        ...
        if($this.wrapper.hasClass('layout-menu-overlay-active')||$this.wrapper.hasClass('layout-menu-static-active')) {
            ...
            $this.leftPanelButton.removeClass('menu-button-rotate');
    ...
    leftPanelOpen: function() {
        if(this.leftPanel.length) {
            this.leftPanel.addClass('layout-leftpanel-active');
            this.closeOverlayMenu();
        }
    },
    
    leftPanelClose: function() {
        if(this.leftPanel.length) {
            this.leftPanel.removeClass('layout-leftpanel-active');
            this.closeOverlayMenu();
        }
